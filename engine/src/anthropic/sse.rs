...
mod tests {
    ...
    use super::super::types::{ContentBlockDelta, MessageDelta, OutputContentBlock, StreamEvent, Usage};
    ...
    fn parses_single_frame() {
        ...
        assert_eq!(
            ...
            Some(StreamEvent::ContentBlockStart(
                super::super::types::ContentBlockStartEvent {
                    index: 0,
    ...
    fn parses_chunked_stream() {
        ...
        assert_eq!(
            ...
            vec![StreamEvent::ContentBlockDelta(
                super::super::types::ContentBlockDeltaEvent {
                    index: 0,
    ...
    fn ignores_ping_and_done() {
        ...
        assert_eq!(
            events,
            vec![
                StreamEvent::MessageDelta(super::super::types::MessageDeltaEvent {
                    delta: MessageDelta {
                ...
                StreamEvent::MessageStop(super::super::types::MessageStopEvent {}),
            ]
        );
    }
